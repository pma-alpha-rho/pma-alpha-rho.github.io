...
<tr style="background-color: white;"><th width="50%"><b>Name</b></th><th width="50%"><b>Notebook Completion %</b></th></tr>
<?php
...
echo "><td width='50%'><a href='common/profile.php?id=$id'><span style='font-size: 20px;'>$name</span></a></td><td width = '50%' align = 'right'>";
echo "$comp_per%</td></tr>";
$count++;
}
...
<a href="../brotrak.php">Brotrak | <a href="common/admin.php">Add a PM</a> | <?php } ?><a href="common/full-report.php">View Full Report</a></div>
